...
parser.add_argument("--target_dim",type=int,default=672,help="the number of different grid locations")
parser.add_argument("--val_batch_size",type=int,default=24)
parser.add_argument("--diff_layers",type=int,default=4)
parser.add_argument("--Num_Comp",type=int,default=5,help="0 reprent N_m, K reprent N_K")  
parser.add_argument("--Lambda",type=float,default=0.5)  
parser.add_argument("--local_prior",action="store_true",default=False)
...
if args.local_prior & (args.predict_len==1):
...
print('test dataset:')
evaluate(args.model,args.history_len,model, test_loader,test_target_tensor,scaler,nsample=50)
